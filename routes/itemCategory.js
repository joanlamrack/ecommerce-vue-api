...
const itemCategoryController = require("../controllers/itemCategoryController.js");
 ...
 */
router.get("/", (req, res) => {
	itemCategoryController.list(req, res);
});
...
router.get("/:id", (req, res) => {
	itemCategoryController.show(req, res);
});
 ...
 */
router.post("/", (req, res) => {
	itemCategoryController.create(req, res);
});
...
router.put("/:id", (req, res) => {
	itemCategoryController.update(req, res);
});
...
router.delete("/:id", (req, res) => {
	itemCategoryController.remove(req, res);
});
